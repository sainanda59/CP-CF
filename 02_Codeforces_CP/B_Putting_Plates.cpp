...
for(ll i=1,j=1;j<=w;j++){
    if((a[i-1][j] + a[i][j-1]+ a[i+1][j] + a[i][j+1] + a[i-1][j-1]+ a[i-1][j+1] + a[i+1][j-1] + a[i+1][j+1])==0)
    a[i][j]=1;
}
for(ll i=1,j=w;i<=h;i++){
    if((a[i-1][j] + a[i][j-1]+ a[i+1][j] + a[i][j+1] + a[i-1][j-1]+ a[i-1][j+1] + a[i+1][j-1] + a[i+1][j+1])==0)
    a[i][j]=1;
}
for(ll i=h,j=w;j>0;j--){
    if((a[i-1][j] + a[i][j-1]+ a[i+1][j] + a[i][j+1] + a[i-1][j-1]+ a[i-1][j+1] + a[i+1][j-1] + a[i+1][j+1])==0)
    a[i][j]=1;
}
for(ll i=h,j=1;i>0;i--){
    if((a[i-1][j] + a[i][j-1]+ a[i+1][j] + a[i][j+1] + a[i-1][j-1]+ a[i-1][j+1] + a[i+1][j-1] + a[i+1][j+1])==0)
    a[i][j]=1;
}
